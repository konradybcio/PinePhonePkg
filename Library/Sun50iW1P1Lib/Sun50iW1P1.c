...
#include <Drivers/AxpPower/Axp81X/Axp81X.h>
  ...
  )
{
  ...
  spare_head = get_spare_head(FixedPcdGet32(PcdFdBaseAddress));
  ...
  SecondaryCpuBringUp(FixedPcdGet32(PcdFdBaseAddress));
...
//  uboot did that for us question mark
