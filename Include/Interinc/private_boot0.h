...
typedef struct _Boot_file_head
{
  ...
  unsigned char   magic[MAGIC_SIZE];  // ="eGON.BT0"
  ...
  unsigned int   boot_cpu;           // eGON version
...
typedef struct _boot0_private_head_t
{
  ...
  unsigned int                         debug_mode;       //debug_mode = 0 : do not print any message,debug_mode = 1 ,print debug message 
