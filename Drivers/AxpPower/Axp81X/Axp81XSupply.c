...
************************************************************************************************************
*/
EFI_STATUS axp81X_set_dc1sw(int onoff)
{
  UINT8   reg_value;
...
************************************************************************************************************
*/
EFI_STATUS axp81X_set_dc5ldo(int onoff)
{
  UINT8   reg_value;
...
************************************************************************************************************
*/
EFI_STATUS axp81X_set_dcdc1(int set_vol, int onoff)
{
  UINT8   reg_value;
...
EFI_STATUS axp81X_probe_dcdc1(void)
{
  UINT8  reg_value;
  if(AxpPmBusRead(AXP81X_ADDR, BOOT_POWER81X_OUTPUT_CTL1, &reg_value))
  {
...
************************************************************************************************************
*/
EFI_STATUS axp81X_set_dcdc2(int set_vol, int onoff)
{
  UINT8   reg_value;
...
************************************************************************************************************
*/
EFI_STATUS axp81X_set_dcdc3(int set_vol, int onoff)
{
  UINT8   reg_value;
...
************************************************************************************************************
*/
EFI_STATUS axp81X_set_dcdc4(int set_vol, int onoff)
{
  UINT8   reg_value;
...
************************************************************************************************************
*/
EFI_STATUS axp81X_set_dcdc5(int set_vol, int onoff)
{
  UINT8   reg_value;
...
************************************************************************************************************
*/
EFI_STATUS axp81X_set_aldo1(int set_vol, int onoff)
{
  UINT8 reg_value;
...
************************************************************************************************************
*/
EFI_STATUS axp81X_set_aldo2(int set_vol, int onoff)
{
  UINT8 reg_value;
...
************************************************************************************************************
*/
EFI_STATUS axp81X_set_aldo3(int set_vol, int onoff)
{
  UINT8 reg_value;
...
************************************************************************************************************
*/
EFI_STATUS axp81X_set_dldo3(int set_vol, int onoff)
{
  UINT8 reg_value;
...
************************************************************************************************************
*/
EFI_STATUS axp81X_set_fldo2(int set_vol, int onoff)
{
  UINT8 reg_value;
...
************************************************************************************************************
*/
EFI_STATUS axp81X_set_dcdc_output(int sppply_index, int vol_value, int onoff)
{
  switch(sppply_index)
  {
    case 1:
...
EFI_STATUS axp81X_set_aldo_output(int sppply_index, int vol_value, int onoff)
{
  switch(sppply_index)
  {
    case 1:
...
EFI_STATUS axp81X_set_dldo_output(int sppply_index, int vol_value, int onoff)
{
  switch(sppply_index)
  {
    case 1:
...
EFI_STATUS axp81X_set_eldo_output(int sppply_index, int vol_value, int onoff)
{
  switch(sppply_index)
  {
    case 1:
...
EFI_STATUS axp81X_set_misc_output(int sppply_index, int vol_value, int onoff)
{
  switch(sppply_index)
  {
...
************************************************************************************************************
*/
EFI_STATUS axp81X_probe_dcdc_output(int sppply_index)
{
  switch(sppply_index)
  {
    case 1:
...
EFI_STATUS axp81X_probe_aldo_output(int sppply_index)
{
  switch(sppply_index)
  {
    case 1:
